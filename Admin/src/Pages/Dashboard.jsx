                ...
                <div className="overflow-scroll">
                  ...
                  <div className="flex bg-gray-400 font-bold lg:max-h-[900px]">
                    <div className="flex flex-col lg:flex-row w-full py-2 h-20 lg:h-[450px] overflow-clip">
                      ...
                      >
                        <div className="w-full h-full m-auto py-6">
                          <p className="hidden bg-red-300 text-red-800">
                            Nunggu Invoice
                          </p>
                          <ApexCharts type="area" inputData={products} />
                        </div>
                      </div>
                      <div className="rounded-xl w-full lg:w-5/12 bg-white">
                        <ApexCharts type="radialBar" inputData={products} />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex bg-gray-400 font-bold lg:max-h-[900px]">
                    <div className="flex flex-col lg:flex-row w-full py-2">
                      ...
                      >
                        <h4>Table Top Products & Order</h4>
