...
import { DropForm } from "./Admins/AdminsForm";
                                ...
                                <div className="relative  text-xl text-center line-clamp-2 s">
                                  <div className="flex gap-12 flex-row justify-center items-center font-semibold text-sm">
                                    <table className="w-full bg-white">
                                      <thead
                                        className={`bg-slate-300 font-roboto-regular`}
                                      >
                                        <tr>
                                          <th>No</th>
                                          <th>Nama Admin</th>
                                  ...
                                  <h1 className="my-4">
                                    Are you sure to delete these selected
                                    admins?
                                  </h1>
                                </div>
                              </div>
