...
export default function Categories() {
  ...
  const columnOrder = ["id", "picture", "name", "type"];
  ...
  if (categories !== null && categories.length > 0) {
    table_styling = {
      ...
      th: columnOrder.map((key, index) => ({
        key,
        feature: ["id", "name", "type"].includes(key) ? "filter" : null,
        ...
        <>
          {categories !== null ? (
            ...
            <div id="Categories" className="rounded-lg text-sm ">
              ...
              {/* ================ Table ================ */}
              <div className="divider">Categories List</div>
                      ...
                      <Td className="print:hidden px-4">
                        {row.id && (
                          <ActionButton
                            ...
                            onClickEdit={() => {
                              handleOpenModal(row.id, "ALTER_BY_ID", "form");
                            }}
                          />
                        )}
                      </Td>
