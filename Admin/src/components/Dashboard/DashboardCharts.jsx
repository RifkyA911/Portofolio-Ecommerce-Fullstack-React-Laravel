...
export const BarsChart = (props) => {
  const { segments, classname = "justify-left text-left", title } = props;
  ...
  return (
    <div>
      {!charts.products[0].data && !segments ? (
        <SkeltonBox className="h-20 lg:h-[450px] w-full rounded-xl" count={1} />
      ) : (
        <div className={`px-2`}>
          <div
          ...
          <Chart
            className="m-auto w-full"
            options={BarStackedoptions(chartOptions)}
